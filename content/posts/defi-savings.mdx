...
For any pool that exposes an ERC-4626 interface — which covers Morpho MetaMorpho, Compound v3, Euler, and most modern vaults — `Erc4626Provider` connects to it in a few lines with no protocol-specific boilerplate:
